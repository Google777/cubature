...
// doCuhre
Rcpp::List doCuhre(int ndim, int ncomp, SEXP f, int maxEval, double absErr, double tol, int key);
RcppExport SEXP cubature_doCuhre(SEXP ndimSEXP, SEXP ncompSEXP, SEXP fSEXP, SEXP maxEvalSEXP, SEXP absErrSEXP, SEXP tolSEXP, SEXP keySEXP) {
BEGIN_RCPP
    ...
    rcpp_result_gen = Rcpp::wrap(doCuhre(ndim, ncomp, f, maxEval, absErr, tol, key));
